	...
	mcgrawhill_esoStyle.prototype = {
		...
		ckEditorStyles: {
			...
			styles: [
				...
				{ name: 'Lista Desordenada Bolinche', element: 'ul', attributes: { 'class': 'bck-ul'} },
				{ name: 'Lista Desordenada Raya', element: 'ul', attributes: { 'class': 'bck-ul-2'} },
				...
				{ name: 'Lista Marrón', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-4' } },
				{ name: 'Lista Roja', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-5' } },
				{ name: 'Lista AzulOscura', element: 'ol', attributes: { 'class': 'bck-ol bck-ol-6' } },
				...
				{ name: 'Caja Reto', type: 'widget', widget: 'blink_box', attributes: { 'class': 'bck-box bck-box-9' } },
		                { name: 'Caja Sabías ', type: 'widget', widget: 'blink_box', attributes: { 'class': 'bck-box bck-box-11' } },
